...
def introduction():
    ...
    st.image('https://github.com/Mohamedsamir08/Hotel_Bookings_EDA-Visualization-Hypothesis_test-and_Revenue_Simulation/blob/Main-Epslion-AI/Hotel_Image.jpg', caption='Your Caption', use_column_width=True, channels='RGB')
